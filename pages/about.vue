<template>
  <div class="About">
    ...
    <static-card>
      {{
        $t(
          '当サイトは新型コロナウイルス感染症 (COVID-19) に関する最新情報を提供するために、帝京大学が開設したものです。'
        )
      }}<br />
      <br />
      {{
        $t(
          '帝京大学による公式情報と客観的な数値をわかりやすく伝えることで、帝京大学にお住まいの方や、帝京大学内に拠点を持つ企業の方、帝京大学を訪れる方が、現状を把握して適切な対策を取れるようにすることを目的としています。'
        )
      }}
    </static-card>
    <static-card>
